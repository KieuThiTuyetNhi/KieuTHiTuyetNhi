          ...
          <tbody>
            ...
            <tr>
              ...
              <td class="text-center">
                 ...
                 <a href="{{route('customer.restore',['customer'=>$customer->id])}}" class="btn btn-sm btn-primary">
                  <i class="fas fa-undo"></i></a>
                 <a href="{{route('customer.destroy',['customer'=>$customer->id])}}" class="btn btn-sm btn-danger">
