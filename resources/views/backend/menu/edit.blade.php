        ...
        <section class="content">
          ...
          <div class="card">
            ...
            <div class="card-body">
             ...
             <div class="row">
                <div class="col-md-12">
                  @if ($menu->type!='custome')
                  <div class="mb-3">
                    <label for="name">Tên menu</label>
                    <input type="text" value="{{old('name',$menu->name)}}" name="name" readonly id='name' class="form-control" placeholder=" Tên menu">
                    @if ($errors->has('name'))
                ...
                <div class="mb-3">
                  ...
                  <input type="text" value="{{old('link',$menu->link)}}" name="link" readonly id='link' class="form-control" placeholder=" Tên menu">
                  @if ($errors->has('link'))
                     <div class="text-danger">
                    {{$errors->first('link')}}  
                    </div> 
                  ...
                  <div class="mb-3">
                    <label for="name">Tên menu</label>
                    <input type="text" value="{{old('name',$menu->name)}}" name="name" id='name' class="form-control" placeholder=" Tên menu">
                    @if ($errors->has('name'))
                       <div class="text-danger">
                      {{$errors->first('name')}}  
                      </div> 
                ...
                <div class="mb-3">
                  <label for="link">Liên kết</label>
                  <input type="text" value="{{old('link',$menu->link)}}" name="link" id='link' class="form-control" placeholder=" Tên menu">
                  @if ($errors->has('link'))
                     <div class="text-danger">
                    {{$errors->first('link')}}  
                    </div> 
