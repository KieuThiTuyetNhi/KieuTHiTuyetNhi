...
class MenuController extends Controller
{
    ...
    public function store(Request $request)
    {
      ...
      foreach($list_id as $id)
       ...
       return redirect()->route('menu.index')->with('message',['type'=>'success',
    ...
    public function show($id)
    {
       ...
       if($menu==null)
       {
        return redirect()->route('menu.index')->with('message',['type'=>'danger',
    ...
    public function destroy($id)
        {
           ...
           if($menu==null)
           {
            return redirect()->route('menu.trash')->with('message',['type'=>'danger',
            'msg'=>'Mẫu tin không tồn tại!']);
           }
           if( $menu->delete())
           {
             ...
             $link->delete();
             return redirect()->route('menu.trash')->with('message',['type'=>'success',
...
// admin menu/status/1  
    public function status($id)
    {
       ...
       $menu->status = ($menu->status == 1) ? 2 : 1;
        ...
        $menu->updated_by = 1;
        $menu->save();
        return redirect()->route('menu.index')->with('message',['type'=>'sucess',
    ...
    public function restore($id)
    {
       ...
       $menu->updated_by = 1;
       $menu->save();
       return redirect()->route('menu.trash')->with('message',['type'=>'sucess',
        'msg'=>'Thay đổi trạng thái thành công!']);
    }
}
