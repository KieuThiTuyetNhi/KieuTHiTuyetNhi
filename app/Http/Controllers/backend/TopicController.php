...
class TopicController extends Controller
{
    ...
    // End upload 
      ...
      return redirect()->route('topic.index')->with('message',['type'=>'danger',
    ...
    public function destroy($id)
        {
           ...
           if($topic==null)
           {
            return redirect()->route('topic.trash')->with('message',['type'=>'danger',
            'msg'=>'Mẫu tin không tồn tại!']);
           }
           if( $topic->delete())
           {
             ...
             $link->delete();
             return redirect()->route('topic.trash')->with('message',['type'=>'success',
...
// admin topic/status/1  
    public function status($id)
    {
       ...
       $topic->status = ($topic->status == 1) ? 2 : 1;
        ...
        $topic->updated_by = 1;
        $topic->save();
        return redirect()->route('topic.index')->with('message',['type'=>'sucess',
    ...
    public function restore($id)
    {
       ...
       $topic->updated_by = 1;
       $topic->save();
       return redirect()->route('topic.trash')->with('message',['type'=>'sucess',
        'msg'=>'Thay đổi trạng thái thành công!']);
    }
}
