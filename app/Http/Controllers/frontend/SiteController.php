...
class SiteController extends Controller
{
    ...
    public function product_category($slug)
    {
        ...
        //var_dump( $arrcatid);
        $list_pro = Product::whereIn("category_id", $arrcatid)->where('status', '=', '1')->orderBy('created_at', 'desc')->paginate(12);
    ...
    public function product_brand($slug)
    {
        ...
        $list_pro = Product::where([['status', '=', '1'], ['brand_id', '=', $row_brand->id]])->orderBy('created_at', 'desc')->paginate(12);
    ...
    {
        $list_pro = Product::where('status', '=', '1')->paginate(8);
        return view('frontend.product_all', compact('list_pro'));
    }
}
